            ...
            <ion-list :inset="true" style="margin: 10px">
                <div style="padding: 10px;">
                    <ion-item>
                        ...
                        <ion-input v-model="stock_in_item_local.item_barcode" :readonly="true" ></ion-input>
                    </ion-item>
                    <ion-item>
                        <ion-label position="stacked">Discription</ion-label>
                        <ion-input v-model="stock_in_item_local.item_description" :readonly="true"></ion-input>
                    </ion-item>
                    <ion-item>
                        <ion-label position="stacked">Unit</ion-label>
                        <ion-input v-model="stock_in_item_local.unit_code" :readonly="true"></ion-input>
                    </ion-item>
                    <ion-item>
                        <ion-row>
                            <ion-col size="6">
                                <ion-label position="stacked">Cost</ion-label>
                                <ion-input @ionInput="updateAmount()" type="number" v-model="stock_in_item_local.cost" placeholder="0.00"></ion-input>
                            </ion-col>
                            <ion-col size="6">
                                <ion-label position="stacked">Quantity</ion-label>
                                <ion-input v-model="stock_in_item_local.quantity" placeholder="0.00"></ion-input>
                            </ion-col>
                        </ion-row>
                    </ion-item>
                    <ion-item>
                        <ion-row>
                            <ion-col>
                                ...
                                <ion-input readonly v-model="stock_in_item_local.amount" placeholder="0.00"></ion-input>
                            </ion-col>
                        </ion-row>
