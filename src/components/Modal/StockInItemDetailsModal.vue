            ...
            <ion-list :inset="true" style="margin: 10px">
                <div style="padding: 10px;">
                    <ion-item>
                        ...
                        <ion-input label="Barcode" label-placement="floating" fill="solid" v-model="stock_in_item_local.item_barcode" :readonly="true" ></ion-input>
                    </ion-item>
                    <ion-item>
                        <!-- <ion-label position="stacked">Discription</ion-label> -->
                        <ion-input label="Discription" label-placement="floating" fill="solid" v-model="stock_in_item_local.item_description" :readonly="true"></ion-input>
                    </ion-item>
                    <ion-item>
                        <!-- <ion-label position="stacked">Unit</ion-label> -->
                        <ion-input label="Unit" label-placement="floating" fill="solid" v-model="stock_in_item_local.unit_code" :readonly="true"></ion-input>
                    </ion-item>
                    <ion-item>
                        <ion-row>
                            <ion-col size="6">
                                ...
                                <InputFloat label="Cost" label-placement="floating" fill="solid" :amount="stock_in_item_local.cost" @update="(floatValue) => stock_in_item_local.cost = floatValue" @ionInput="updateAmount()"></InputFloat>
                            </ion-col>
                            <ion-col size="6">
                                ...
                                <InputFloat label="Quantity" label-placement="floating" fill="solid" :amount="stock_in_item_local.quantity" @update="(floatValue) => stock_in_item_local.quantity = floatValue" @ionInput="updateAmount()"></InputFloat>
                            </ion-col>
                        </ion-row>
                    </ion-item>
                    <ion-item>
                        <ion-row>
                            <ion-col>
                                ...
                                <InputFloat label="Amount" label-placement="floating" fill="solid" :amount="stock_in_item_local.amount" @update="(floatValue) => stock_in_item_local.amount = floatValue"></InputFloat>
                            </ion-col>
                        </ion-row>
