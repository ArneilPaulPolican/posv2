                ...
                <ion-item>
                    <ion-row>
                        <ion-col size="6">
                            ...
                            <ion-input label="Date" label-placement="floating" fill="solid" :disabled="is_locked" :readonly="true" v-model="stock_out.out_date" ></ion-input>
                        </ion-col>
                        <ion-col size="6">
                            <!-- <ion-label position="stacked">Status</ion-label> -->
                            <ion-input label="Status" label-placement="floating" fill="solid" :disabled="is_locked" v-model="stock_out.status" placeholder="New" ></ion-input>
                        </ion-col>
                    </ion-row>
                </ion-item>
                <ion-item>
                    <!-- <ion-label position="stacked">Remarks</ion-label> -->
                    <ion-textarea label="Remarks" label-placement="floating" fill="solid" :disabled="is_locked" v-model="stock_out.remarks" placeholder="Remarks" ></ion-textarea>
                </ion-item>
            </ion-list>
