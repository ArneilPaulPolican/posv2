        ...
        <ion-item>
            ...
            <ion-row>
                <ion-col size="6">
                    ...
                    <ion-input :readonly="true" v-model="cash_in_cash_out.cash_in_out_date" placeholder="MM/dd/yyyy"></ion-input>
                </ion-col>
                <ion-col size="6">
                    <ion-label position="stacked">Number</ion-label>
                    <ion-input :readonly="true" v-model="cash_in_cash_out.cash_in_out_number" placeholder="0000000001"></ion-input>
                </ion-col>
            </ion-row>
        </ion-item>
        <ion-content :fullscreen="true">
            <div style="padding: 5px;">
                    ...
                    <ion-grid style="padding: 0px;">
                        <ion-row style="padding: 0px;">
                            <ion-col size="6" style="padding: 0px;">
                                ...
                                <ion-input :disabled="is_locked" @ionInput="updateAmount" v-model="cash_in_cash_out.cash_1000" placeholder="0"></ion-input>
                            </ion-col>
                            <ion-col size="6" style="padding: 0px;">
                    ...
                    <ion-grid style="padding: 0px;">
                        <ion-row style="padding: 0px;">
                            <ion-col size="4" style="padding: 0px;">
                                ...
                                <ion-input :disabled="is_locked" @ionInput="updateAmount" v-model="cash_in_cash_out.cash_500" placeholder="0"></ion-input>
                            </ion-col>
                            <ion-col size="4">
                                <ion-label position="stacked">200 bill</ion-label>
                                <ion-input :disabled="is_locked" @ionInput="updateAmount" v-model="cash_in_cash_out.cash_200" placeholder="0"></ion-input>
                            </ion-col>
                            <ion-col size="4">
                                <ion-label position="stacked">100 bill</ion-label>
                                <ion-input :disabled="is_locked" @ionInput="updateAmount" v-model="cash_in_cash_out.cash_100" placeholder="0"></ion-input>
                            </ion-col>
                        </ion-row>
                    </ion-grid>
                </ion-item>
                    ...
                    <ion-grid style="padding: 0px;">
                        <ion-row style="padding: 0px;">
                            <ion-col size="6" style="padding: 0px;">
                                ...
                                <ion-input :disabled="is_locked" @ionInput="updateAmount" v-model="cash_in_cash_out.cash_50" placeholder="0"></ion-input>
                            </ion-col>
                            <ion-col size="6">
                                <ion-label position="stacked">20 bill(s)/coin(s) </ion-label>
                                <ion-input :disabled="is_locked" @ionInput="updateAmount" v-model="cash_in_cash_out.cash_20" placeholder="0"></ion-input>
                            </ion-col>
                        </ion-row>
                    </ion-grid>
                </ion-item>
                    ...
                    <ion-grid style="padding: 0px;">
                        <ion-row style="padding: 0px;">
                            <ion-col size="6" style="padding: 0px;">
                                ...
                                <ion-input :disabled="is_locked" @ionInput="updateAmount" v-model="cash_in_cash_out.cash_10" placeholder="0"></ion-input>
                            </ion-col>
                            <ion-col size="6">
                                <ion-label position="stacked">5 coin(s)</ion-label>
                                <ion-input :disabled="is_locked" @ionInput="updateAmount" v-model="cash_in_cash_out.cash_5" placeholder="0"></ion-input>
                            </ion-col>
                        </ion-row>
                    </ion-grid>
                </ion-item>
                <ion-item>
                    ...
                    <ion-input :disabled="is_locked" @ionInput="updateAmount" v-model="cash_in_cash_out.cash_1" placeholder="0"></ion-input>
                </ion-item>
                <h3>Centavo</h3>
                <ion-item>
                    <ion-grid style="padding: 0px;">
                        <ion-row style="padding: 0px;">
                            <ion-col size="6" style="padding: 0px;">
                                ...
                                <ion-input :disabled="is_locked" @ionInput="updateAmount" v-model="cash_in_cash_out.cash_dot_25" placeholder="0"></ion-input>
                            </ion-col>
                            <ion-col size="6">
                                <ion-label position="stacked">10 cent(s)</ion-label>
                                <ion-input :disabled="is_locked" @ionInput="updateAmount" v-model="cash_in_cash_out.cash_dot_10" placeholder="0"></ion-input>
                            </ion-col>
                        </ion-row>
                    </ion-grid>
                </ion-item>
                    ...
                    <ion-grid>
                        <ion-row>
                            <ion-col size="6">
                                ...
                                <ion-input :disabled="is_locked" @ionInput="updateAmount" v-model="cash_in_cash_out.cash_dot_5" placeholder="0"></ion-input>
                            </ion-col>
                            <ion-col size="6">
                                <ion-label position="stacked">1 cent(s)</ion-label>
                                <ion-input :disabled="is_locked" @ionInput="updateAmount" v-model="cash_in_cash_out.cash_dot_1" placeholder="0"></ion-input>
                            </ion-col>
                        </ion-row>
                    </ion-grid>
                </ion-item>
